"""Phase 7 source reliability notes and provider replacement playbooks."""
    ...
    for playbook in playbooks:
        ...
        artifacts.append(
            ArtifactIndex.for_directory(
                ...
                base_dir=artifact_dir,
                created_at=created_at,
                produced_by="phase7_provider_replacement_playbook",
                tool_run_id=tool_run_id,
...
_DEFAULT_PROVIDER_REPLACEMENT_SPECS = (
    ProviderReplacementSpec(
        ...
        artifact_schema_versions=("phase4-market-data.v1",),
    ...
    ProviderReplacementSpec(
        ...
        artifact_schema_versions=("phase4-news-evidence.v1",),
    ...
    ProviderReplacementSpec(
        ...
        expected_artifact_type="normalized_evidence",
        replacement_artifact_type="normalized_evidence",
        artifact_schema_versions=("phase4-social-evidence.v1",),
        credential_requirements=("NLP_STOCK_PREDICTION_SCRAPE_USER_AGENT",),
    ...
    ProviderReplacementSpec(
        ...
        artifact_schema_versions=("phase4-fundamentals.v1",),
    ...
    ProviderReplacementSpec(
        ...
        expected_artifact_type="provider_result",
        replacement_artifact_type="provider_result",
        artifact_schema_versions=("phase4-macro-context.v1",),
    ...
    ProviderReplacementSpec(
        ...
        expected_artifact_type="normalized_evidence",
        replacement_artifact_type="normalized_evidence",
        artifact_schema_versions=("phase4-scrape-evidence.v1",),
