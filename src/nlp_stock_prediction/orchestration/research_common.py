"""Shared helpers for Research Stage evidence and analysis tools."""
...
class ResearchToolResult:
    """Stable summary returned by Research Stage tools after SQLite/artifact writes."""
...
def scoped_source_evidence(
    ...
    *,
    ...
    metadata["research_tool"] = tool_slug
