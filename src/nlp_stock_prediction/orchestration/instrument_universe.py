"""Fixture-backed Instrument-Universe Stage instrument universe discovery."""
...
INSTRUMENT_UNIVERSE_SCHEMA_VERSION = "instrument_universe.instrument-universe.v1"
INSTRUMENT_UNIVERSE_FIXTURE_PROVIDER = "instrument_universe-fixture-directory"
...
@dataclass(frozen=True)
class FixtureUniverseTool:
    """Deterministic fixture Adapter for Instrument-Universe Stage universe discovery."""
    ...
    def run(
        ...
        *,
        ...
        universe = build_fixture_universe(
        ...
        return InstrumentUniverseToolResult(
            universe=universe,
            artifact_payload=instrument_universe_artifact_payload(run_id=run_id, universe=universe),
...
def build_fixture_universe(
    *,
    ...
    return InstrumentUniverse(
        ...
        warnings=warnings,
        metadata={
            "schema_version": INSTRUMENT_UNIVERSE_SCHEMA_VERSION,
            "provider": INSTRUMENT_UNIVERSE_FIXTURE_PROVIDER,
            "source": "fixture",
            "summary": (
...
def instrument_universe_artifact_payload(
    *,
    run_id: str,
    universe: InstrumentUniverse,
) -> JsonObject:
...
def instrument_record_from_contract(instrument: Instrument) -> InstrumentRecord:
    ...
    return instrument_to_record(instrument, metadata={"instrument_universe": True})
    ...
    return Instrument(
        ...
        provider_ids=(
            ProviderInstrumentId(
                ...
                metadata={"source": "instrument_universe_fixture"},
            ),
        ),
        tradability_evidence=(
            TradabilityEvidence(
                ...
                raw_identifier=f"{provider_identifier.upper()}:instrument_universe-fixture",
                notes=notes,
                metadata={"source": "instrument_universe_fixture"},
            ),
        ),
        ...
        metadata={"stage": "instrument_universe", "fixture": True},
    )
...
__all__ = [
    "INSTRUMENT_UNIVERSE_FIXTURE_PROVIDER",
    "INSTRUMENT_UNIVERSE_SCHEMA_VERSION",
    "FixtureUniverseTool",
    "InstrumentUniverseTool",
    "InstrumentUniverseToolResult",
    "build_fixture_universe",
