"""Research Stage prediction evaluation service adapter."""
...
class ResearchPredictionEvaluationRun:
    """Summary of evaluations written for a Research Stage run."""
...
def evaluate_stored_prediction_candidates(
    *,
...
) -> ResearchPredictionEvaluationRun:
    ...
    if not candidate_records:
        return ResearchPredictionEvaluationRun(
            payload={
                "candidate_count": 0,
                "evaluation_count": 0,
...
__all__ = ["ResearchPredictionEvaluationRun", "evaluate_stored_prediction_candidates"]
