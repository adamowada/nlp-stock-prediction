...
- **Phase 4:** Active. Build, fine-tune, evaluate, score-guard, and document a local Google TimesFM 2.5 technical-analysis model for a given stock, using native Windows RTX 3090 training as the primary path.
