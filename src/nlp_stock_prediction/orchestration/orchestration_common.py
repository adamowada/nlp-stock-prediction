"""Shared Codex Smoke Stage orchestration helpers."""
...
class ArtifactWritePolicy:
    """Resolve Codex Smoke Stage write paths while enforcing ignored repo roots."""
...
def codex_smoke_instrument(symbol: str, retrieved_at: datetime) -> Instrument:
    ...
    return Instrument(
        ...
        metadata={"codex_smoke_mcp": True},
    )


def codex_smoke_run_id(run_date: date, symbol: str) -> str:
