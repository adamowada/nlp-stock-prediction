...
RUN_ID = "run-evaluation-calibration"
...
def test_calibration_summary_computes_reliability_bins_and_metrics() -> None:
    summary = compute_calibration_summary(
        ...
        cohort_id="evaluation-evalcal-stage6-msft-swing",
...
def test_calibration_summary_keeps_unresolved_cohort_metric_free() -> None:
    summary = compute_calibration_summary(
        ...
        cohort_id="evaluation-evalcal-stage6-pending",
        created_at=SUMMARY_CREATED_AT,
        as_of=AS_OF,
...
def test_calibration_summary_identity_includes_families_and_clears_stale_slices(
    ...
    all_families = write_calibration_summary_artifact(
        ...
        artifact_dir=tmp_path / "reports" / RUN_ID / "audit",
        run_id=RUN_ID,
        cohort_id="evaluation-evalcal-stage6-family-identity",
        inputs=inputs,
        as_of=AS_OF,
        created_at=SUMMARY_CREATED_AT,
        bin_edges=BIN_EDGES,
