...
def _signal_reference(
    *,
    ...
    return SignalArtifactReference(
        ...
        schema_version="evaluation-signal.v1",
...
@pytest.mark.schema
def test_evaluation_prediction_evaluation_target_captures_point_in_time_snapshot() -> None:
    target = _target()
...
@pytest.mark.schema
def test_evaluation_prediction_evaluation_target_rejects_signal_lookahead() -> None:
...
@pytest.mark.schema
def test_evaluation_prediction_evaluation_target_requires_baseline_or_limitation() -> None:
    payload = _target().model_dump()
...
@pytest.mark.schema
def test_evaluation_outcome_artifact_payload_wraps_target_and_outcome() -> None:
...
@pytest.mark.schema
def test_evaluation_outcome_artifact_payload_rejects_target_mismatch() -> None:
...
@pytest.mark.schema
def test_evaluation_outcome_evaluation_payload_preserves_review_metadata() -> None:
...
@pytest.mark.schema
def test_evaluation_outcome_evaluation_payload_rejects_pre_evaluation_artifact_time() -> None:
...
@pytest.mark.schema
def test_evaluation_outcome_rejects_fixed_window_observation_before_window_end() -> None:
...
@pytest.mark.schema
def test_evaluation_outcome_evaluation_rejects_status_result_mismatch() -> None:
...
@pytest.mark.schema
def test_evaluation_outcome_evaluation_rejects_evaluation_before_observed_at() -> None:
    outcome = _outcome().model_copy(
...
@pytest.mark.schema
def test_evaluation_baseline_comparison_rejects_inconsistent_math() -> None:
...
@pytest.mark.schema
def test_calibration_summary_accepts_resolved_prediction_quality_metrics() -> None:
...
@pytest.mark.schema
def test_signal_family_ablation_accepts_resolved_prediction_quality_delta() -> None:
...
@pytest.mark.schema
def test_calibration_summary_requires_limitations_without_resolved_outcomes() -> None:
...
@pytest.mark.schema
def test_signal_family_ablation_requires_resolved_samples_or_limitations() -> None:
