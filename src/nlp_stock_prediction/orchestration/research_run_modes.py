"""Run-mode adapters for Research Stage report execution."""
...
class ResearchMarketDataSelection:
...
@dataclass(frozen=True)
class ResearchRunModeAdapter:
    """Concrete live/offline behavior behind one Research Stage run-mode Interface."""

    report_data_mode: ReportDataMode
    store: SQLiteStore
    fixtures: ResearchFixtureProviderFactory
    live_providers: ResearchLiveProviderFactoryProtocol
    ...
    def market_data_selection(self, symbol: str) -> ResearchMarketDataSelection:
        ...
        if self.is_live:
            ...
            return ResearchMarketDataSelection(
...
__all__ = [
    "ResearchMarketDataSelection",
    "ResearchRunModeAdapter",
    "ResearchSocialProviderSelection",
]
