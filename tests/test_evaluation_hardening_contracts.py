...
def _artifact_freshness_review() -> ArtifactFreshnessReview:
    return ArtifactFreshnessReview(
        ...
        produced_by="live_outcome_materialization",
        reviewed_at=NOW,
...
@pytest.mark.schema
def test_reliability_outcome_review_summary_preserves_audit_context() -> None:
...
@pytest.mark.schema
def test_reliability_outcome_review_summary_rejects_unresolved_metrics() -> None:
...
@pytest.mark.schema
def test_reliability_source_reliability_note_requires_external_traceability() -> None:
...
@pytest.mark.schema
def test_reliability_contracts_reject_non_live_data_modes() -> None:
...
@pytest.mark.schema
def test_reliability_provider_playbook_requires_compatible_replacement_notes() -> None:
...
@pytest.mark.schema
def test_reliability_provider_playbook_accepts_limited_compatible_swap() -> None:
...
@pytest.mark.schema
def test_calibration_drift_check_preserves_separate_artifact_context() -> None:
...
@pytest.mark.schema
def test_reliability_calibration_drift_rejects_duplicate_source_artifacts() -> None:
...
@pytest.mark.schema
def test_reliability_calibration_drift_rejects_inline_report_coupling() -> None:
