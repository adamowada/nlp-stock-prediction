"""Research Stage fundamentals evidence and analysis tool."""
...
RESEARCH_FUNDAMENTALS_SCHEMA_VERSION = "research.fundamentals.v1"
RESEARCH_FUNDAMENTALS_TOOL_NAME = "research_fundamentals"
RESEARCH_FUNDAMENTALS_TOOL_SLUG = "research-fundamentals"


@dataclass(frozen=True)
class ResearchFundamentalsTool:
    ...
    def run(
        ...
        *,
        ...
        request = FundamentalsRequest(
            request_id=f"research-fundamentals-{run_id}-{normalized_symbol}",
            run_date=run_date,
        ...
        tool_run_id, artifact_id, filename = tool_identity(
            tool_slug=RESEARCH_FUNDAMENTALS_TOOL_SLUG,
            run_id=run_id,
        ...
        with safe_research_tool_execution(
            ...
            artifact_path = write_research_json_artifact(
                ...
                produced_by=RESEARCH_FUNDAMENTALS_TOOL_NAME,
                tool_run_id=tool_run_id,
                schema_version=RESEARCH_FUNDAMENTALS_SCHEMA_VERSION,
                artifact_id=artifact_id,
...
def run_research_fundamentals_tool(
    *,
    store: SQLiteStore,
    repo_root: Path,
    artifact_dir: Path,
    ...
    return ResearchFundamentalsTool(providers=tuple(providers)).run(
        store=store,
        repo_root=repo_root,
        artifact_dir=artifact_dir,
        run_id=run_id,
...
__all__ = [
    "RESEARCH_FUNDAMENTALS_SCHEMA_VERSION",
