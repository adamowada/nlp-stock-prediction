...
from nlp_stock_prediction.orchestration.research_common import retrieval_method_for_provider
from nlp_stock_prediction.orchestration.research_live_providers import ResearchLiveProviderFactory
...
@pytest.mark.unit
def test_research_live_provider_factory_uses_public_yahoo_market_data_without_alpha_key() -> None:
    factory = ResearchLiveProviderFactory(env={})
...
@pytest.mark.unit
def test_research_live_provider_factory_uses_shared_market_data_selector() -> None:
    factory = ResearchLiveProviderFactory(env={})
