...
PHASE4_SOCIAL_SCHEMA_VERSION = "phase4.social-evidence.v1"
PHASE4_SOCIAL_TOOL_NAME = "phase4_social_evidence"
PHASE4_SOCIAL_TOOL_SLUG = "phase4-social-evidence"


@dataclass(frozen=True)
class Phase4SocialEvidenceTool:
    ...
    def run(
        ...
        *,
        ...
        request = EvidenceRequest(
            request_id=f"phase4-social-{run_id}-{normalized_symbol}",
            run_date=run_date,
            tickers=tickers,
            limit=limit,
        ...
        tool_run_id, artifact_id, filename = tool_identity(
            tool_slug=PHASE4_SOCIAL_TOOL_SLUG,
            run_id=run_id,
        ...
        with safe_phase4_tool_execution(
            ...
            artifact_path = write_phase4_json_artifact(
                ...
                produced_by=PHASE4_SOCIAL_TOOL_NAME,
                tool_run_id=tool_run_id,
                schema_version=PHASE4_SOCIAL_SCHEMA_VERSION,
                artifact_id=artifact_id,
...
def run_phase4_social_evidence_tool(
    *,
    store: SQLiteStore,
    repo_root: Path,
    artifact_dir: Path,
    ...
    return Phase4SocialEvidenceTool(
